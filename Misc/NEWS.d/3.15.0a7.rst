...
:class:`re.Pattern` similarly gains a :meth:`re.Pattern.prefixmatch` method.
...
unadorned "match" name in Python has been a frequent case of confusion and
coding bugs due to the inconsistency with the rest of the software industry.
